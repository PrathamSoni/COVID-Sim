...
function Model() {
    this.initialize = function(socialDistance, mortality, sickTime) {
        ...
        for(let i=0; i<this.doctorPopulation; i++){
          ...
          let y=Math.random() * arenaHeight;
          if(i==0){
            let inInner=(((x>arenaWidth/2-25&&x<arenaWidth/2+25)&&(y>arenaHeight/2-25&&y<arenaHeight/2+25)));
            let inOuter=(((x>arenaWidth/2-20&&x<arenaWidth/2+20)&&(y>arenaHeight/2-20&&y<arenaHeight/2+20)));
            while(!inOuter||inInner){
              x=Math.random() * arenaWidth;
              y=Math.random() * arenaWidth;
              inInner=(((x>arenaWidth/2-25&&x<arenaWidth/2+25)&&(y>arenaHeight/2-25&&y<arenaHeight/2+25)));
              inOuter=(((x>arenaWidth/2-20&&x<arenaWidth/2+20)&&(y>arenaHeight/2-20&&y<arenaHeight/2+20)));
              }
